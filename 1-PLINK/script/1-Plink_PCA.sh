...
# 定义输入和输出路径
INPUT_VCF="/mnt/d/幽门螺旋杆菌/Script/分析结果/1-序列处理流/output/merge/merged_biallelic_2819.NoN.maf99.WGS.recode.SNP.noN.vcf.gz"
OUTPUT_DIR="/mnt/d/幽门螺旋杆菌/Script/分析结果/3-PCA/2899_hpEAsia_maf99_SNP-noN"
mkdir -p "$OUTPUT_DIR"
PLINK_PREFIX="${OUTPUT_DIR}/filtered"
PCA_OUTPUT_DIR="/mnt/d/幽门螺旋杆菌/Script/分析结果/3-PCA/2899_hpEAsia_maf99_SNP-noN"
