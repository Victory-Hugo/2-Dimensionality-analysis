...
# 定义输入和输出路径
INPUT_VCF="/mnt/c/Users/Administrator/Desktop/cleaned.vcf.gz"
OUTPUT_DIR="/mnt/c/Users/Administrator/Desktop/filtered"
mkdir -p "$OUTPUT_DIR"
PLINK_PREFIX="${OUTPUT_DIR}/filtered"
PCA_OUTPUT_DIR="/mnt/c/Users/Administrator/Desktop/filtered_PCA"
